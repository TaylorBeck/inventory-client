...
const defaultSettings: UserSetting[] = [
  { label: 'Name', value: 'al_capone', type: 'text' },
  { label: 'Email', value: 'al.capone@gmail.com', type: 'text' },
              ...
              >
                ...
                <td className="py-2 px-4">
                  {setting.type === 'toggle' ? (
                    ...
                    <input
                      type="text"
                      className="px-4 py-2 border rounded-lg text-gray-500 focus:outline-none focus:border-blue-500 w-"
